        ...
        <section className="h-[800px] relative bg-accent/10 xl:bg-white" id="home">
            ...
            <div className="container mx-auto h-full">
                ...
                <div className="hidden xl:flex w-[55vw] h-[800px] absolute top-0 right-0 bg-accent">
                    <div className="absolute w-[558px] h-[642px] botom-0 z-40 left-[6.5vw] top-[100px]">
                        <Image
                    ...
                    <div className="absolute top-[500px] left-[3vw]" data-scroll data-scroll-speed="0.2">
                        <RotatingShape content={<Image src="assets/hero/shape-1.svg" width={38} height={38} alt="" />} direction="left" duration={6} />
                    </div>
                    <div className="absolute top-[200px] xl:left-[37vw]" data-scroll data-scroll-speed="0.1">
                        <RotatingShape content={<Image src="assets/hero/shape-2.svg" width={34} height={34} alt="" />} direction="right" duration={5} />
                    </div>
                    <div className="absolute top-[480px] xl:left-[47vw]" data-scroll data-scroll-speed="0.08">
